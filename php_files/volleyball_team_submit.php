<?php
    ...
    $check_query = "select * from volleyball_team where user = '" . $Post_data['user'] . "';";
    $check_result = $con->query($check_query);
    if($check_result->num_rows < 3){
     $query = "insert into volleyball_team (user, country, area, name1, role1, age1, tall1,
                 name2, role2, age2, tall2, name3, role3, age3, tall3, name4, role4, age4, tall4,
                 name5, role5, age5, tall5, name6, role6, age6, tall6, chosenDate, chosenMonth, chosenYear, team_name, active)
                 ...
                 "', '" . $Post_data['member6'][0] . "', '" . $Post_data['member6'][1]. "', '" . $Post_data['member6'][2] . "', '" . $Post_data['member6'][3] .
