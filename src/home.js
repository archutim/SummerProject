    ...
    return (
      ...
      <Container style={{alignContent:'center', alignSelf:'center'}}>
        <Header hasTabs>
          ...
          <Body>
            <Title>{this.props.route.params.user}</Title>
          </Body>
          <Right>
          ...
          <Tabs>
            <Tab heading={ <TabHeading><Text>Basketball</Text></TabHeading>}>
              <Tab1 navigation={this.props.navigation} user={this.props.route.params.user}/>
            </Tab>
            <Tab heading={ <TabHeading><Text>VolleyBall</Text></TabHeading>}>
              <Tab2 navigation={this.props.navigation} user={this.props.route.params.user}/>
            </Tab>
