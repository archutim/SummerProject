...
export default class Team_create extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            isReady: false,
    ...
    Submit(){
        if(this.state.name1 == '' || this.state.name2 == '' || this.state.name3 == '' || this.state.name4 == '' || this.state.name5 == '' || this.state.age1 == '' || this.state.age2 == '' || this.state.age3 == '' || this.state.age4 == '' || this.state.age5 == '' || this.state.tall1 == '' || this.state.tall2 == '' || this.state.tall3 == '' || this.state.tall4 == '' || this.state.tall5 == '')
            alert('Invalid Info!')
        else
            fetch('http://192.168.1.113/php/basketball_team_submit.php', {
                method: 'POST',
                header: {
                    ...
                    <Form>
                        <Card>
                            ...
                            <Body>
                                ...
                                <Item>
                                    ...
                                    >   
                                        <Picker.Item label="小前鋒" value="SF"/>
                                        <Picker.Item label="大前鋒" value="PF"/>
                                        <Picker.Item label="中鋒" value="C"/>
                                        <Picker.Item label="得分後衛" value="SG"/>
                                        <Picker.Item label="控球後衛" value="PG"/>
                                    </Picker>
                                </Item>
                                <Item last>
                                    <Input placeholder="年齡" onChangeText={(age) => this.setState({age1: age})}/>
                                    <Input placeholder="身高" onChangeText={(tall) => this.setState({tall1: tall})}/>
                                </Item>
                            </Body>
                            </CardItem>
                        </Card>
                        <Card>
                            ...
                            <Body>
                                ...
                                <Item last>
                                    <Input placeholder="年齡" onChangeText={(age) => this.setState({age2: age})}/>
                                    <Input placeholder="身高" onChangeText={(tall) => this.setState({tall2: tall})}/>
                                </Item>
                            </Body>
                            </CardItem>
                        </Card>
                        <Card>
                            ...
                            <Body>
                                ...
                                <Item last>
                                    <Input placeholder="年齡" onChangeText={(age) => this.setState({age3: age})}/>
                                    <Input placeholder="身高" onChangeText={(tall) => this.setState({tall3: tall})}/>
                                </Item>
                            </Body>
                            </CardItem>
                        </Card>
                        <Card>
                            ...
                            <Body>
                                ...
                                <Item last>
                                    <Input placeholder="年齡" onChangeText={(age) => this.setState({age4: age})}/>
                                    <Input placeholder="身高" onChangeText={(tall) => this.setState({tall4: tall})}/>
                                </Item>
                            </Body>
                            </CardItem>
                        </Card>
                        <Card>
                            ...
                            <Body>
                                ...
                                <Item last>
                                <Input placeholder="年齡" onChangeText={(age) => this.setState({age5: age})}/>
                                    <Input placeholder="身高" onChangeText={(tall) => this.setState({tall5: tall})}/>
                                </Item>
                            </Body>
                            </CardItem>
                        </Card>
